...
const ModernPartnerCard = styled(Card)(({ theme }) => ({
  ...
  borderRadius: 20,
  padding: '20px',
  background: theme.palette.mode === 'dark' ? 'rgba(18, 21, 27, 0.75)' : theme.palette.background.paper,
  ...
  gap: '16px',
  boxShadow: theme.palette.mode === 'dark' ? '0 8px 32px rgba(0, 0, 0, 0.3)' : '0 8px 24px rgba(0, 0, 0, 0.06)',
  position: 'relative',
  overflow: 'hidden',
  flexShrink: 0,
